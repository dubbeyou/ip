...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_MARK = "Ssss... Thisss task isss already marked as done!";
    ...
    public static final String MESSAGE_UNMARK_TASK = "Ssss... I'ves marked thisss task as not done yet:\n  %s";
